...
namespace Application\Success\CoreBundle\Util;
...
class Util {
  ...
  public static function getDisplayCountry($code){
    return (array_key_exists($code, self::$countries) ? self::$countries[$code] : self::$countries['UY']);
  }
}
