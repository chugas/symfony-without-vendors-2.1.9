(function(a){
    a.fn.webwidget_vertical_menu=function(p){
        ...
        var g=p&&p.menu_text_color?p.menu_text_color:"black";
        var h=p&&p.menu_border_size?p.menu_border_size:"0";
        var i=p&&p.menu_background_color?p.menu_background_color:"#00FF99";
        var j=p&&p.menu_border_color?p.menu_border_color:"#00FF99";
        var k=p&&p.menu_border_style?p.menu_border_style:"solid";
        var l=p&&p.menu_width?p.menu_width:"250";
        var n=p&&p.menu_height?p.menu_height:"36";
        var r=p&&p.menu_margin?p.menu_margin:"0";
        var v=p&&p.menu_background_hover_color?p.menu_background_hover_color:"#00FF99";
