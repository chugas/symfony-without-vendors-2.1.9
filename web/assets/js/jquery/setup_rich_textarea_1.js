    ...
    triggers: [
          ...
          */
          ...
          callback: function( term, response )
          {
            ...
            var tags = [ 
                    { label: 'Calico Jack Rackham', value: { value: 'pirate1', content: '<span class="nombre"><a href="/perfil-usuario.php">Calico Jack Rackham</a></span>' } },
                    { label: 'Edward England', value: { value: 'pirate2', content: '<span class="nombre"><a href="/perfil-usuario.php">Edward England</a></span>' } },
                    { label: 'Blackbeard Edward Teach',	value: { value: 'pirate3', content: '<span class="nombre"><a href="/perfil-usuario.php">BlackBeard (Edward Teach)</a></span>' } },
                    { label: 'Bartholomew Roberts', value: { value: 'pirate4', content: '<span class="nombre"><a href="/perfil-usuario.php">Bartholomew Roberts</a></span>' } }
            ];
